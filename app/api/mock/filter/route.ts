...
async function runFilterAgentMock(promptId: ObjectId, options: {
    sampleJobs?: Job[];
...
export async function POST(req: NextRequest) {
    const { promptId, actorName } = await req.json() as { promptId?: ObjectId; actorName?: string; };
