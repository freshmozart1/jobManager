...
import { normaliseEducationItems, sortEducationItems } from "@/lib/education";
...
function getItemLabel(item: PersonalInformationEducation): string {
    ...
    return (
        ...
        >
            {(editor) => {
                ...
                function EducationEditorInner({ editor }: { editor: EditorApi }) {
                                                ...
                                                <div className="flex items-start justify-between gap-3">
                                                    ...
                                                    <div className="flex items-center gap-1">
                                                        ...
                                                        <Button
                                                            ...
                                                            onClick={() => {
                                                                if (interactionsLocked) return;
                                                                void editor.deleteByIndices([index], "Failed to delete education. Item was restored.");
                                                            }}
                                                            disabled={interactionsLocked}
                                                        >
                ...
                return <EducationEditorInner editor={editor} />;
            }}
        </AppItemEditor>
    );
}
